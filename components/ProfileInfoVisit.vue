<template>
  <div class="info-visit">
    ...
    <img
      ...
      class="info-visit__img"
    />
    <div class="info-visit__container">
      <div class="info-visit__container__basic">
        <p class="info-visit__container__basic__name">
          {{ userInfo.first_name }} {{ userInfo.last_name }}
        </p>
      </div>
      <div class="info-visit__container__extra">
        <p class="info__container__extra__description">
          {{ userInfo.description }}
        </p>
        <div class="info-visit__container__extra__numbers">
          <p class="info__container__extra__numbers__posts">
            {{ postPublished.length }}
          </p>
          <p class="info__container__extra__numbers__ratings">
            {{ user_rating.toFixed(2) }} / 5.00
          </p>
          <p class="info-visit__container__extra__numbers__interests">
            <span
...
export default {
  ...
  created() {
    this.fetchRating(this.userInfo)
  },
  methods: {
    imageUrl(id) {
